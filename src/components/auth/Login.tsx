  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-400 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">PupTrack</h1>
        <p className="text-gray-500 mb-8">Smart potty training for your household</p>
        ...
        <p className="text-xs text-gray-400 mt-6">
          Track your puppy's patterns together with your household
        </p>
      </div>
    </div>
  );
